...
output1='BW046_n20_multi'
output2='BW051_n20_multi'

/usr/bin/time -v /projects/bgmp/shared/groups/2023/ml-mice/sgolubev/ml_hmm_mice/SSM_Train/test_fitting_with_ray.py -i $input1 -c $choices1 -e $output1 -s 20
/usr/bin/time -v /projects/bgmp/shared/groups/2023/ml-mice/sgolubev/ml_hmm_mice/SSM_Train/test_fitting_with_ray.py -i $input2 -c $choices2 -e $output2 -s 20