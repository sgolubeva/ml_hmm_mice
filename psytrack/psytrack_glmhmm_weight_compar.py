...
def get_glmhmm_dinmc_weights(fit_ll, inpts):

    """Takes   . Calculates dinamic weights for each data point in glm-hmm model by multiplying 
...
def fit_psytrack(psy_track_data):
    ...
    weights = {'bias': 1,
               'inpt1': 2} # key is the one of the inputs key from the data dictionary, value is how
...
if __name__ == "__main__":
    ...
    fig = psy.plot_weights(wMode, weights2)
